              ...
              return (
                ...
                >
                  ...
                  >
                    {/* Avatar */}
                    <motion.div
                      className="w-16 h-16 mx-auto rounded-full mb-3 shadow-lg overflow-hidden relative"
                    ...
                    >
                      ...
                      <div className={`w-full h-full bg-gradient-to-br ${gradient} flex items-center justify-center text-white text-xl font-extrabold ${instructor.avatarUrl ? 'hidden' : ''}`}>
            ...
            {filteredInstructors.map((instructor, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {/* Avatar */}
                    <div className="w-14 h-14 flex-shrink-0 rounded-full shadow-lg overflow-hidden relative">
                      {instructor.avatarUrl ? (
                        <img
                          src={instructor.avatarUrl}
                          alt={instructor.name}
                      ...
                      <div className={`w-full h-full bg-gradient-to-br ${gradient} flex items-center justify-center text-white text-lg font-extrabold ${instructor.avatarUrl ? 'hidden' : ''}`}>
                        {instructor.name.charAt(0)}
                      </div>
                    </div>
