  ...
  return (
    <div className="pb-20 lg:pb-0">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
        {[
          { icon: MessageSquare, label: 'Live Chat', desc: 'Chat with our support team', color: 'text-sky-500 bg-sky-50 dark:bg-sky-900/20', page: 'support-chat' as const },
          { icon: Mail, label: 'Email Us', desc: 'support@dakkho.pro.bd', color: 'text-emerald-500 bg-emerald-50 dark:bg-emerald-900/20', page: 'email-us' as const },
        ].map((item, i) => (
          <motion.div
            key={item.label}
