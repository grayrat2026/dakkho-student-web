...
export function RefundPolicyPage() {
  ...
  useEffect(() => {
    async function fetchContent() {
      try {
        const result = await termsApi.getActive('refund_policy');
            ...
            <GlassCard className="p-5">
              ...
              <div className="space-y-2">
                {[
                  ...
                  'For any refund disputes, please contact our support team at billing@dakkho.pro.bd before escalating to your payment provider.',
                ].map((note, i) => (
              ...
              <div className="mt-4 p-3 rounded-xl bg-sky-50 dark:bg-sky-900/20 flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-sky-600 dark:text-sky-400">Contact us at billing@dakkho.pro.bd or visit Help & Support</p>
                </div>
              </div>
            </GlassCard>
          </motion.div>
